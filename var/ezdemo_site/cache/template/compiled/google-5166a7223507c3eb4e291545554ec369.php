...
// Filename:  design/admin2/templates/navigator/google.tpl
// Timestamp: 1342179292 (Fri Jul 13 11:34:52 UTC 2012)
$oldSetArray_9bf19025dc71bcf94361b4cf769aab42 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '><span class="text">&laquo;&nbsp;Zurück</span></a></span>
       ';
    } break;
    default:
    {
$text .= '      <span class="previous"><span class="text disabled">&laquo;&nbsp;Zurück</span></span>
       ';
    } break;
}
unset( $match );
...
$text .= '><span class="text">Weiter&nbsp;&raquo;</span></a></span>
      ';
    } break;
    default:
    {
$text .= '        <span class="next"><span class="text disabled">Weiter&nbsp;&raquo;</span></span>
      ';
    } break;
}
unset( $match );
...
$setArray = $oldSetArray_9bf19025dc71bcf94361b4cf769aab42;
$tpl->Level--;
?>
