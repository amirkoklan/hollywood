...
// Timestamp: 1339513469 (Tue Jun 12 15:04:29 UTC 2012)
$oldSetArray_2b4cff1aab7df97ed00efb04e615c6fe = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'add-child-tag\'] = { \'url\': "/hollywood/index.php/site_admin/tags/add/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'edit-tag\'] = { \'url\': "/hollywood/index.php/site_admin/tags/edit/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'delete-tag\'] = { \'url\': "/hollywood/index.php/site_admin/tags/delete/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'merge-tag\'] = { \'url\': "/hollywood/index.php/site_admin/tags/merge/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'add-synonym-tag\'] = { \'url\': "/hollywood/index.php/site_admin/tags/addsynonym/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'make-synonym-tag\'] = { \'url\': "/hollywood/index.php/site_admin/tags/makesynonym/%tagID%" };';
}
unset( $if_cond );
// if ends
...
$text .= '    menuArray[\'TagMenuSimple\'] = { \'depth\': 0, \'headerID\': \'tag-simple-header\' };
    ...
    menuArray[\'TagMenuSimple\'][\'elements\'][\'add-child-tag-simple\'] = { \'url\': "/hollywood/index.php/site_admin/tags/add/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '        <a id="edit-tag" href="#" onmouseover="ezpopmenu_mouseOver( \'TagMenu\' )">Schlagwort bearbeiten</a>
    ';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_2b4cff1aab7df97ed00efb04e615c6fe;
$tpl->Level--;
?>
