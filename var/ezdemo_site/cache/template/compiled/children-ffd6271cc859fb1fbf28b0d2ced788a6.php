<?php
// URI:       design/admin2/templates/children.tpl
// Filename:  design/admin2/templates/children.tpl
// Timestamp: 1342179297 (Fri Jul 13 11:34:57 UTC 2012)
$oldSetArray_824f1e6b77a5adce28a7d91c63424022 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'item_type', $rootNamespace ) )
{
  ...
  2 => 'design/admin2/templates/children.tpl',
) );
...
<form name="children" method="post" action="/hollywood/index.php/site_admin/content/action">
...
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
    $var3 = $var3->templateValue();
$var = $var1 ? $var3 : '"/hollywood/index.php/site_admin"';
unset( $var1, $var3 );
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
...
$text .= ' title="Eine Ebene nach oben."><img src="/hollywood/design/admin2/images/up-16x16-grey.png" width="16" height="16" alt="Eine Ebene nach oben." title="Eine Ebene nach oben." /></a>&nbsp;';
unset( $var );
unset( $var2 );
unset( $var3 );
unset( $var3 );
...
$var = strtr( 'Untergeordnete Einträge (%children_count)', $var3 );
...
$text .= '" />
    ...
    ';
$oldRestoreIncludeArray_4d042cb7532b0bd43e08c8982e2d8341 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/children_detailed-935d65f8f6e32511935f0ed7dc338da7.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
$tpl->createLocalVariablesList();
$tpl->appendTemplateFetch( 'design/admin2/templates/children_detailed.tpl' );
include( '' . 'var/ezdemo_site/cache/template/compiled/children_detailed-935d65f8f6e32511935f0ed7dc338da7.php' );
...
$tpl->processURI( 'design/admin2/templates/children_detailed.tpl', true, $extraParameters, $textElements, $rootNamespace, $currentNamespace );
...
$restoreIncludeArray = $oldRestoreIncludeArray_4d042cb7532b0bd43e08c8982e2d8341;
...
$text .= '
    ...
    <div class="context-toolbar">
    ';
$oldRestoreIncludeArray_7ec8e1a2d71d6afe60c064174590e6bc = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/alphabetical-c3add895f16b35cfd308caf2ccc7b923.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'navigator' : ( $currentNamespace . ':' . 'navigator' );
$tpl->createLocalVariablesList();
$tpl->appendTemplateFetch( 'design/admin2/templates/navigator/alphabetical.tpl' );
include( '' . 'var/ezdemo_site/cache/template/compiled/alphabetical-c3add895f16b35cfd308caf2ccc7b923.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$textElements = array();
$extraParameters = array();
$tpl->processURI( 'design/admin2/templates/navigator/alphabetical.tpl', true, $extraParameters, $textElements, $rootNamespace, $currentNamespace );
$text .= implode( '', $textElements );
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_7ec8e1a2d71d6afe60c064174590e6bc;
...
$setArray = $oldSetArray_824f1e6b77a5adce28a7d91c63424022;
$tpl->Level--;
?>
