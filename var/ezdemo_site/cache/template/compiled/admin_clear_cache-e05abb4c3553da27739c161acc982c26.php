<?php
// URI:       design/admin2/templates/toolbar/full/admin_clear_cache.tpl
// Filename:  design/admin2/templates/toolbar/full/admin_clear_cache.tpl
// Timestamp: 1342179297 (Fri Jul 13 11:34:57 UTC 2012)
$oldSetArray_827b2eb9187ae12d14212cfa5bfbd240 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '	       <h4><span class="disabled">Cache leeren</span></h4>
	    ';
}
else
{
...
<div class="box-bc"><div class="box-ml"><div class="box-content">
    ...
    ';
$oldRestoreIncludeArray_3b3cd24c945d38896c68cc183ff8f8c6 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/clear_cache-13c97e10b8c19c0d7d306e0671b8a1f0.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/clear_cache-13c97e10b8c19c0d7d306e0671b8a1f0.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_3b3cd24c945d38896c68cc183ff8f8c6;
...
$setArray = $oldSetArray_827b2eb9187ae12d14212cfa5bfbd240;
$tpl->Level--;
?>
