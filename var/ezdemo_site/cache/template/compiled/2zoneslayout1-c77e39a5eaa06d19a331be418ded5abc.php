...
$oldSetArray_9f5d5aaf5297e6bb0ff03cec97f04fce = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '                ';
$oldRestoreIncludeArray_b716635c97b80855fe6dd76a0c16d807 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/zone_block-0e81b057fd6f26fb73fca05725a1da8d.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/zone_block-0e81b057fd6f26fb73fca05725a1da8d.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_b716635c97b80855fe6dd76a0c16d807;
...
$text .= '                    ';
$oldRestoreIncludeArray_a546b3859fc71dc03a94fe908061537a = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_a546b3859fc71dc03a94fe908061537a;
...
$setArray = $oldSetArray_9f5d5aaf5297e6bb0ff03cec97f04fce;
$tpl->Level--;
?>
