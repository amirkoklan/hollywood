<?php
// URI:       design/admin2/templates/infocollection_validation.tpl
// Filename:  design/admin2/templates/infocollection_validation.tpl
// Timestamp: 1342179298 (Fri Jul 13 11:34:58 UTC 2012)
$oldSetArray_aa3cf4a377e870304b6dba3e304c82c8 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= ']</span> Die Information konnte nicht gesammelt werden.</h2>
            <p>Entweder wurden benötigte Felder nicht ausgefüllt oder die Eingaben waren nicht gültig:</p>
            <ul>
                ';
unset( $loopItem );
unset( $loopItem );
...
$setArray = $oldSetArray_aa3cf4a377e870304b6dba3e304c82c8;
$tpl->Level--;
?>
