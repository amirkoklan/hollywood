...
$oldSetArray_6e49d87c85149ae6b42be968016ac10b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '  ';
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_144 );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441 );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441 );
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'module_result', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['module_result'] : null;
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_1442 = compiledFetchAttribute( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441, 'title_path' );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441 );
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1442;
if (! isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441 ) ) $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441 = NULL;
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441->templateValue();
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441->templateValue();
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_144 = isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441 );unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1441 );
if (! isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_144 ) ) $elseif_cond_af6bb285068f6883d01f24f7adda1d55_144 = NULL;
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_144 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_144, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_144 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_144->templateValue();
...
elseif ( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_144 )
{
$text .= '    ';
unset( $var );
unset( $var );
...
{
$text .= '    ';
$oldRestoreIncludeArray_c8206c79511c250ec96eb3a889111d62 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/canonical_link-782c7032d9c03d12472deccc4d2d5e6c.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/canonical_link-782c7032d9c03d12472deccc4d2d5e6c.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_c8206c79511c250ec96eb3a889111d62;
...
{
$text .= '    ';
$oldRestoreIncludeArray_f0002a6d604d4f91330b1451a0815425 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/link-5a5f5485ff0beb48b1ece512a6baa6c5.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/link-5a5f5485ff0beb48b1ece512a6baa6c5.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_f0002a6d604d4f91330b1451a0815425;
...
$setArray = $oldSetArray_6e49d87c85149ae6b42be968016ac10b;
$tpl->Level--;
?>
