...
$oldSetArray_bbe9db79d32296adadb128261a21d4bd = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<div id="contentstructure">
    ';
$oldRestoreIncludeArray_2aa9f908293176d0711083f0edbb36ac = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/content_structure_menu_dynamic-fa75c2dcc740863118cab42e8613ee7b.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/content_structure_menu_dynamic-fa75c2dcc740863118cab42e8613ee7b.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_2aa9f908293176d0711083f0edbb36ac;
...
$text .= ' title="Den Inhalt des Papierkorbs ansehen und verwalten."><img src="/hollywood/design/admin2/images/trash-icon-16x16.gif" width="16" height="16" alt="Papierkorb" />&nbsp;<span>Papierkorb</span></a>
</div>';
}
unset( $if_cond );
// if ends
...
';
$oldRestoreIncludeArray_28997865df00794e2bfa7b667d346a09 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/ini_menu-c0524ee4651853cb5b49b4d031365d2f.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/ini_menu-c0524ee4651853cb5b49b4d031365d2f.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_28997865df00794e2bfa7b667d346a09;
...
$setArray = $oldSetArray_bbe9db79d32296adadb128261a21d4bd;
$tpl->Level--;
?>
