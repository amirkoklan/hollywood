...
$oldSetArray_990e0873de1a0769ca74ce8439aa8cb2 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '><img src="/hollywood/design/admin2/images/current-user.gif" height="22" width="22" alt="" style="text-align: left; vertical-align: middle;" /></a>&nbsp;<a style="font-weight: normal; text-decoration: none; color: #000000" href=';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'current_user_link', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['current_user_link'] : null;
if (! isset( $var ) ) $var = NULL;
...
{
$text .= '        <p><img src="/hollywood/design/admin2/images/current-user-disabled.gif" height="22" width="22" alt="" style="text-align: left; vertical-align: middle;" /> ';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'current_user', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['current_user'] : null;
...
$text .= ' title="Ändern von Name, E-Mail, Passwort etc.">Informationen ändern</a>
    ';
}
else
{
$text .= '        <span class="disabled">Benutzer-Informationen ändern</span>
    ';
}
unset( $if_cond );
// if ends
...
$text .= '</div></li>
    <li><div><a href="/hollywood/index.php/site_admin/user/password" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$var1 = strtr( 'Benutzerpasswort für <%username> ändern.', $var4 );
...
$text .= '</p>
    <ul>
    <li><div><span class="disabled">Benutzer-Informationen ändern</span></div></li>
    <li><div><span class="disabled">Passwort ändern</span></div></li>
    </ul>';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_990e0873de1a0769ca74ce8439aa8cb2;
$tpl->Level--;
?>
