...
$oldSetArray_36400bc78e98fd279d4fa77eedc00e4a = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '<form class="span4 form-search" method="get" action="/hollywood/index.php/content/search" id="site-wide-search">
...
$setArray = $oldSetArray_36400bc78e98fd279d4fa77eedc00e4a;
$tpl->Level--;
?>
