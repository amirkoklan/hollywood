<?php
// URI:       design/admin2/templates/translations.tpl
// Filename:  design/admin2/templates/translations.tpl
// Timestamp: 1342179297 (Fri Jul 13 11:34:57 UTC 2012)
$oldSetArray_e8d047184578f7ab24a8f713fb2c4f26 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'object_can_edit', $rootNamespace ) )
{
  ...
  2 => 'design/admin2/templates/translations.tpl',
) );
...
$text .= '
<form name="translationsform" method="post" action="/hollywood/index.php/site_admin/content/translation">
...
<fieldset>
<legend>Bestehende Übersetzungen</legend>

<table id="tab-translations-list" class="list" cellspacing="0" summary="Liste der Übersetzungen des aktuellen Objkts.">
<tr>
    <th class="tight"><img src="/hollywood/design/admin2/images/toggle-button-16x16.gif" width="16" height="16" alt="Auswahl umkehren." title="Auswahl umkehren." onclick="ezjs_toggleCheckboxes( document.translationsform, \'LanguageID[]\' ); return false;"/></th>
    <th>Sprache</th>
    <th>Örtlichkeit</th>
...
$text .= ' title="Betrachte Übersetzung.">';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'Translations', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['Translations'] : null;
$var1 = compiledFetchAttribute( $var, 'item' );
...
$text .= '" title="Verwenden Sie diese Optionsfelder, um die gewünschte Hauptsprache auszuwählen." />
';
}
unset( $if_cond );
// if ends
...
$text .= '><img src="/hollywood/extension/ezdemo/design/ezdemo/images/edit.gif" width="16" height="16" alt="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$var1 = strtr( 'In der Sprache <%language_name> bearbeiten.', $var4 );
...
if ( $if_cond )
{
$text .= '    <input class="button" type="submit" name="RemoveTranslationButton" value="Ausgewähltes entfernen" title="Ausgewählte Sprache(n) aus der obigen Liste entfernen." />
    ';
}
else
{
$text .= '    <input class="button-disabled" type="submit" name="RemoveTranslationButton" value="Ausgewähltes entfernen" title="Keine entfernbare Sprache vorhanden." disabled="disabled" />
    ';
}
unset( $if_cond );
// if ends
...
{
$text .= '    <input class="button-disabled" type="submit" name="RemoveTranslationButton" value="Ausgewähltes entfernen" disabled="disabled" title="Sie können keine Sprachen entfernen, weil Sie nicht die Berechtigung haben, das aktuelle Element zu bearbeiten." />';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    <input id="tab-translations-list-set-main" class="button" type="submit" name="UpdateInitialLanguageButton" value="Als Haupt setzen" title="Wählen Sie die gewünschte Hauptsprache aus und klicken Sie die Schaltfläche, um die Einstellungen zu speichern." />
...
{
$text .= '    <input class="button-disabled" type="submit" name="UpdateInitialLanguageButton" value="Als Haupt setzen" disabled="disabled" title="Sie können die Hauptsprache nicht ändern, weil das Objekt noch nicht in andere Sprachen übersetzt wurde." />
    ';
}
unset( $if_cond );
// if ends
...
{
$text .= '    <input class="button-disabled" type="submit" name="UpdateInitialLanguageButton" value="Als Haupt setzen" disabled="disabled" title="Sie können die Hauptsprache des Objekts nicht ändern, weil Sie keine Berechtigung haben, das aktuelle Objekt zu bearbeiten." />';
}
unset( $if_cond );
// if ends
...
$text .= ' /> Die Hauptsprache verwenden, wenn keine vorrangige Übersetzung vorhanden ist.
</div>
...
if ( $if_cond )
{
$text .= '    <input id="tab-translations-alwaysavailable-btn" class="button" type="submit" name="UpdateAlwaysAvailableButton" value="Aktualisieren" title="Verwenden Sie diese Schaltfläche, um die Einstellungen des obigen Kontrollkästchens zu speichern." />
    <script type="text/javascript">
...
{
$text .= '    <input class="button-disabled" disabled="disabled" type="submit" name="UpdateAlwaysAvailableButton" value="Aktualisieren" title="Sie haben keine Berechtigung, diese Einstellung zu ändern." />';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_e8d047184578f7ab24a8f713fb2c4f26;
$tpl->Level--;
?>
