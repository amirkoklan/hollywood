...
$oldSetArray_30bc9d8e80995ad88d5315d267f02094 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '">
';
$oldRestoreIncludeArray_c27835d6a3e3308486768459ecd7ece1 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/infocollection_validation-3c1392f6478edb3e1d0b41fb24010655.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/infocollection_validation-3c1392f6478edb3e1d0b41fb24010655.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_c27835d6a3e3308486768459ecd7ece1;
...
<p class="left modified">Zuletzt geändert: ';
unset( $var );
...
';
$oldRestoreIncludeArray_c54961b8fa32d5a6c02a36850b65d201 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/window_controls-9445a0aafffe27a6e5f9f034af1a1089.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/window_controls-9445a0aafffe27a6e5f9f034af1a1089.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_c54961b8fa32d5a6c02a36850b65d201;
...
<form method="post" action="/hollywood/index.php/site_admin/content/action">
...
if ( $if_cond )
{
$text .= '                <option value="">Neue Übersetzung</option>
            ';
}
unset( $if_cond );
// if ends
...
$text .= '    <input class="button" type="submit" name="EditButton" value="Bearbeiten" title="Den Inhalt dieses Eintrags bearbeiten." />';
}
else
{
$text .= '    <select name="ContentObjectLanguageCode" disabled="disabled">
    ...
    <input class="button-disabled" type="submit" name="EditButton" value="Bearbeiten" title="Sie haben nicht die notwendigen Rechte dieses Element zu bearbeiten." disabled="disabled" />';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    <input class="button" type="submit" name="MoveNodeButton" value="Verschieben" title="Diesen Eintrag zu einem anderen Ort verschieben." />';
}
else
{
$text .= '    <input class="button-disabled" type="submit" name="MoveNodeButton" value="Verschieben" title="Sie haben nicht die erforderlichen Rechte dieses Element an einen anderen Ort zu verschieben." disabled="disabled" />';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    <input class="button" type="submit" name="ActionRemove" value="Entfernen" title="Diesen Eintrag entfernen." />';
}
else
{
$text .= '    <input class="button-disabled" type="submit" name="ActionRemove" value="Entfernen" title="Sie besitzen nicht die notwendigen Rechte, um dieses Element zu entfernen." disabled="disabled" />';
}
unset( $if_cond );
// if ends
...
$text .= ' title="Versionen des derzeitigen Objekts ansehen und verwalten (hinzufügen/entfernen).">Versionen verwalten</a>
    </p>
</div>
...
{
$text .= '    ';
$oldRestoreIncludeArray_219ab993c13f097f2cac1499214e000f = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/children-ffd6271cc859fb1fbf28b0d2ced788a6.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/children-ffd6271cc859fb1fbf28b0d2ced788a6.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_219ab993c13f097f2cac1499214e000f;

}
else
{
$text .= '    ';
$oldRestoreIncludeArray_6b177ffb308bcb837a38aede63d53c87 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/no_children-b1d133f4bba2eac429672063f499a16b.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/no_children-b1d133f4bba2eac429672063f499a16b.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_6b177ffb308bcb837a38aede63d53c87;
...
$setArray = $oldSetArray_30bc9d8e80995ad88d5315d267f02094;
$tpl->Level--;
?>
