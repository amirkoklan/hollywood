<?php
// URI:       design/admin2/templates/page_head_script.tpl
// Filename:  design/admin2/templates/page_head_script.tpl
// Timestamp: 1342179294 (Fri Jul 13 11:34:54 UTC 2012)
$oldSetArray_1866fc4537a1804a531ebadb0154f0bd = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'load_javascript_list', $rootNamespace ) )
{
  ...
  2 => 'design/admin2/templates/page_head_script.tpl',
) );
...
$setArray = $oldSetArray_1866fc4537a1804a531ebadb0154f0bd;
$tpl->Level--;
?>
