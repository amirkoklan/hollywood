...
$oldSetArray_c1751a89719ad3419e78a5ba0262601e = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
//menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-view\'] = { \'url\': "/hollywood/index.php/site_admin/content/view/full/%nodeID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-preview\'] = { \'url\': "/hollywood/index.php/site_admin/content/versionview/%objectID%/%version%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-edit\'] = { \'url\': "/hollywood/index.php/site_admin/content/edit/%objectID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-copy\'] = { \'url\': "/hollywood/index.php/site_admin/content/copy/%objectID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-copy-subtree\'] = { \'url\': "/hollywood/index.php/site_admin/content/copysubtree/%nodeID%" };
...
<div class="popupmenu" id="SubitemsContextMenu">
    ...
    <a id="child-menu-preview" href="#" onmouseover="ezpopmenu_mouseOver( \'SubitemsContextMenu\' )">Vorschau</a>';
// if begins
unset( $if_cond );
unset( $if_cond );
...
$setArray = $oldSetArray_c1751a89719ad3419e78a5ba0262601e;
$tpl->Level--;
?>
