...
// Filename:  design/admin2/templates/popupmenu/popup_sub_siteaccess_menus.tpl
// Timestamp: 1342179294 (Fri Jul 13 11:34:54 UTC 2012)
$oldSetArray_cdd41bb884302a598ef0182b6b8562b1 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'siteAccessList', $rootNamespace ) )
{
  ...
  2 => 'design/admin2/templates/popupmenu/popup_sub_siteaccess_menus.tpl',
) );
...
$setArray = $oldSetArray_cdd41bb884302a598ef0182b6b8562b1;
$tpl->Level--;
?>
