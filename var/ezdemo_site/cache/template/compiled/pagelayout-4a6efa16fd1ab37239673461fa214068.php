...
$oldSetArray_a9ea7591c5e476fdd9b5a49a4785688c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$textStack[] = $text;
$text = '';
$oldRestoreIncludeArray_6738bc5ff78fcafc4e4784c1c61a2abe = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head-b37ad3045e3be42f6c0633c1851fd91a.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head-b37ad3045e3be42f6c0633c1851fd91a.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_6738bc5ff78fcafc4e4784c1c61a2abe;

$oldRestoreIncludeArray_00aa7d9f4c354469a0af09b524cfaf08 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head_style-572c0a863fa2ec0ff1bb6334c99d5d33.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head_style-572c0a863fa2ec0ff1bb6334c99d5d33.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_00aa7d9f4c354469a0af09b524cfaf08;

$oldRestoreIncludeArray_45ab6a1d9da2649048a24c69381dd6e5 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head_script-fbf7b873e76e008b532b52e3f673b3af.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head_script-fbf7b873e76e008b532b52e3f673b3af.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_45ab6a1d9da2649048a24c69381dd6e5;
...
';
$oldRestoreIncludeArray_bdbbc7f628912f9e1fa3db813e40867d = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_header-e3f19456b1dd34cf326f4cc93bea4f44.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_header-e3f19456b1dd34cf326f4cc93bea4f44.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_bdbbc7f628912f9e1fa3db813e40867d;

$text .= '
';
$oldRestoreIncludeArray_e7f1f4df0193e4a24f1cab1dd2768bb2 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_topmenu-7b4755b658ab7977b0a14d0d5ef7b63f.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_topmenu-7b4755b658ab7977b0a14d0d5ef7b63f.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_e7f1f4df0193e4a24f1cab1dd2768bb2;
...
if ( $if_cond )
{
$text .= '    <a id="rightmenu-showhide" class="show-hide-control" title="Rechtes Menu ein/ausblenden" href="/hollywood/index.php/site_admin/user/preferences/set/admin_right_menu_show/1">&laquo;</a>
    <div id="rightmenu-design"></div>';
}
else
{
$text .= '    <a id="rightmenu-showhide" class="show-hide-control" title="Rechtes Menu aus/einblenden" href="/hollywood/index.php/site_admin/user/preferences/set/admin_right_menu_show/0">&raquo;</a>
    <div id="rightmenu-design">
        ';
$oldRestoreIncludeArray_e43143b732269fdc0c6e80ab4fa849dc = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_current_user-8f27bc3598988455a750117115b1b37d.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_current_user-8f27bc3598988455a750117115b1b37d.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_e43143b732269fdc0c6e80ab4fa849dc;

$oldRestoreIncludeArray_12b99196ae4e3c0b4b73235c905994e8 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_preferences-831c622e6fba977e4a6d0354c281e25f.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_preferences-831c622e6fba977e4a6d0354c281e25f.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_12b99196ae4e3c0b4b73235c905994e8;

$oldRestoreIncludeArray_ce2896d9db2111a7dc27ecbb21d76454 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_bookmarks-61dde57a6f06d1849b6dd4c5d8fac37d.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_bookmarks-61dde57a6f06d1849b6dd4c5d8fac37d.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_ce2896d9db2111a7dc27ecbb21d76454;

$text .= '        ';
$oldRestoreIncludeArray_7974542f75852a2482af9e9a2ac656d2 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_clear_cache-e05abb4c3553da27739c161acc982c26.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_clear_cache-e05abb4c3553da27739c161acc982c26.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_7974542f75852a2482af9e9a2ac656d2;

$oldRestoreIncludeArray_333361b4361482ac0c5ba158684b3157 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_quick_settings-70c09c509443faa1e156a535ebd4fda5.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_quick_settings-70c09c509443faa1e156a535ebd4fda5.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_333361b4361482ac0c5ba158684b3157;
...
<div id="path-design">
    ';
$oldRestoreIncludeArray_e8efd9072c0816564e77a003803d48a2 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_toppath-bd8be587ef84a1622de8906abb1aa9b2.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_toppath-bd8be587ef84a1622de8906abb1aa9b2.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_e8efd9072c0816564e77a003803d48a2;
...
{
$text .= '    ';
$oldRestoreIncludeArray_f8c01c0e7b7d1c23c86dbdb4d64163cb = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_leftmenu-d3ca04dbe4fd2bb7123675e903d34acb.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_leftmenu-d3ca04dbe4fd2bb7123675e903d34acb.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_f8c01c0e7b7d1c23c86dbdb4d64163cb;
...
{
$text .= '    ';
$oldRestoreIncludeArray_ce3fce115aa9a24b61869cad67d1051a = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_mainarea-8830222250e079baca4e1505e1494be5.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_mainarea-8830222250e079baca4e1505e1494be5.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_ce3fce115aa9a24b61869cad67d1051a;
...
$text .= '    <div id="maincontent">
    ...
    <!-- Maincontent START -->
    ';
$oldRestoreIncludeArray_3b8c725ade1bc8b76a3a9ae77077dbf8 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_3b8c725ade1bc8b76a3a9ae77077dbf8;
...
<div id="footer-design">
    ';
$oldRestoreIncludeArray_21ab6f0063061f24d6f06450a2d862b7 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_copyright-f0f27e83009ad7badd8b634ddda92a22.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_copyright-f0f27e83009ad7badd8b634ddda92a22.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_21ab6f0063061f24d6f06450a2d862b7;
...
';
$oldRestoreIncludeArray_82ac4fadb35344d34270092a8a9cf7dc = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/popup_menu-e81cf7fdb63c5c9d38a40a3746fc2563.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/popup_menu-e81cf7fdb63c5c9d38a40a3746fc2563.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_82ac4fadb35344d34270092a8a9cf7dc;
...
<img src="/hollywood/design/admin2/images/2/loader.gif" id="ajaxuploader-loader" style="display:none;" alt="Loading..." />
...
$setArray = $oldSetArray_a9ea7591c5e476fdd9b5a49a4785688c;
$tpl->Level--;
?>
