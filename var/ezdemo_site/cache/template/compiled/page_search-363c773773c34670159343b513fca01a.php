...
$oldSetArray_ef1833e4e1c75f960431f19fb8a61109 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'search_title', $rootNamespace ) )
{
  ...
  2 => 'design/admin2/templates/page_search.tpl',
    ...
    $tpl->setVariable( 'search_title', 'Den kompletten Inhalt durchsuchen', $rootNamespace );
}
else
{
    $tpl->setLocalVariable( 'search_title', 'Den kompletten Inhalt durchsuchen', $rootNamespace );
}

$text .= '<div class="searchblock">
<form action="/hollywood/index.php/site_admin/content/search" method="get">
    ';
// if begins
unset( $if_cond );
unset( $if_cond );
...
$text .= '" />
        <input id="searchbutton" class="button-disabled hide" name="SearchButton" type="submit" value="Suchen" disabled="disabled" />
        <p class="advanced hide"><span class="disabled">Fortgeschritten</span></p>
    ';
}
else
{
...
$text .= '" />
        <input id="searchbutton" class="button hide" name="SearchButton" type="submit" value="Suchen" />
        ';
// if begins
unset( $if_cond );
unset( $if_cond1 );
...
{
$text .= '            <p class="advanced hide"><a href="/hollywood/index.php/site_admin/content/advancedsearch" title="Fortgeschrittene Suche.">Fortgeschritten</a></p>
        ';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_ef1833e4e1c75f960431f19fb8a61109;
$tpl->Level--;
?>
