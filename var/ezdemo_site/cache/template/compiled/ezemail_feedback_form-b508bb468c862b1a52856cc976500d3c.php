<?php
// URI:       design:content/datatype/collect/ezemail.tpl
// Filename:  extension/ezdemo/design/ezdemo/override/templates/datatype/collect/ezemail_feedback_form.tpl
// Timestamp: 1381794969 (Mon Oct 14 23:56:09 UTC 2013)
$oldSetArray_984317c2c845c0edecbbc837911d5cf6 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'attribute_base', $rootNamespace ) )
{
  ...
  2 => 'extension/ezdemo/design/ezdemo/override/templates/datatype/collect/ezemail_feedback_form.tpl',
) );
...
$setArray = $oldSetArray_984317c2c845c0edecbbc837911d5cf6;
$tpl->Level--;
?>
