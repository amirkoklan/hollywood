...
$oldSetArray_546f1acdc8e215f85cb43ad70099f020 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form method="post" action="/hollywood/index.php/content/action" class="contact-form">
    <fieldset>
        <label>
...
$setArray = $oldSetArray_546f1acdc8e215f85cb43ad70099f020;
$tpl->Level--;
?>
