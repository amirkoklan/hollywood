...
// Filename:  design/admin2/templates/page_toppath.tpl
// Timestamp: 1342179298 (Fri Jul 13 11:34:58 UTC 2012)
$oldSetArray_249c28cfd4592fb28d5b07da6fe638c6 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<p class="path"><span class="path-here-text">Sie sind hier:</span>';
unset( $loopItem );
unset( $loopItem );
...
$setArray = $oldSetArray_249c28cfd4592fb28d5b07da6fe638c6;
$tpl->Level--;
?>
