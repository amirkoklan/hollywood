...
$oldSetArray_0922dff297f554c4802455a431b6772e = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<link rel="Home" href="/hollywood/index.php/site_admin" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$var1 = strtr( '%sitetitle Startseite', $var4 );
...
$text .= '" />
<link rel="Index" href="/hollywood/index.php/site_admin" />
<link rel="Top"  href="/hollywood/index.php/site_admin" title="';
unset( $var );
unset( $var );
...
$text .= '" />
<link rel="Search" href="/hollywood/index.php/site_admin/content/advancedsearch" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$var1 = strtr( 'Suche %sitetitle', $var4 );
unset( $var3, $var4, $var5, $var6 );
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
    $var1 = $var1->templateValue();
...
$text .= '" />
<link rel="Shortcut icon" href="/hollywood/design/standard/images/favicon.ico" type="image/x-icon" />
<link rel="Copyright" href="/hollywood/index.php/site_admin/ezinfo/copyright" />
<link rel="Author" href="/hollywood/index.php/site_admin/ezinfo/about" />
<link rel="Alternate" type="application/rss+xml" title="RSS" href="/hollywood/index.php/site_admin/rss/feed/my_feed" />
';
// if begins
unset( $if_cond );
unset( $if_cond );
...
$setArray = $oldSetArray_0922dff297f554c4802455a431b6772e;
$tpl->Level--;
?>
