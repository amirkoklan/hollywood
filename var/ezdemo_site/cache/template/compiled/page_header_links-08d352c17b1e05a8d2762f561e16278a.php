...
$oldSetArray_1d944556aed50e4d47c4a75a15b9c6b1 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= ' title="Site map">Site map</a></li>
    ';
// if begins
unset( $if_cond );
unset( $if_cond1 );
...
if ( $if_cond )
{
$text .= '    <li id="shoppingbasket"><a href="/hollywood/index.php/de/shop/basket" title="Shopping basket">Shopping basket</a></li>
   ';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    <li id="myprofile"><a href="/hollywood/index.php/de/user/edit" title="My profile">My profile</a></li>
    <li id="logout"><a href="/hollywood/index.php/de/user/logout" title="Logout">Logout ( ';
unset( $var );
unset( $var1 );
unset( $var1 );
...
if ( $if_cond )
{
$text .= '    <li id="registeruser"><a href="/hollywood/index.php/de/user/register" title="Register">Register</a></li>
    ';
}
unset( $if_cond );
// if ends
...
$text .= '    <li id="login" class="transition-showed">
        ...
        <form class="login-form span3" action="/hollywood/index.php/de/user/login" method="post">
            <fieldset>
                <label>
                ...
                <div class="clearfix">
                    <a href="/hollywood/index.php/de/user/forgotpassword" class="forgot-password">Forgot your password?</a>
...
$setArray = $oldSetArray_1d944556aed50e4d47c4a75a15b9c6b1;
$tpl->Level--;
?>
