...
$oldSetArray_7b86cea6765b0c7c135c90266796cf76 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$var1 = array( "All", $var2, "false" );unset( $var2 );
...
$var2 = array( "Content", $var3, "false" );unset( $var3 );
if (! isset( $var2 ) ) $var2 = NULL;
while ( is_object( $var2 ) and method_exists( $var2, 'templateValue' ) )
    $var2 = $var2->templateValue();
unset( $var3 );
...
$var3 = array( "ContentNode", $var4, "true" );unset( $var4 );
if (! isset( $var3 ) ) $var3 = NULL;
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
    $var3 = $var3->templateValue();
unset( $var4 );
unset( $var5 );
$var5 = 'Inhalt - Teil der Baumstruktur' ;
if (! isset( $var5 ) ) $var5 = NULL;
while ( is_object( $var5 ) and method_exists( $var5, 'templateValue' ) )
    $var5 = $var5->templateValue();
$var4 = array( "ContentSubtree", $var5, "true" );unset( $var5 );
if (! isset( $var4 ) ) $var4 = NULL;
while ( is_object( $var4 ) and method_exists( $var4, 'templateValue' ) )
    $var4 = $var4->templateValue();
unset( $var5 );
...
$var8 = array( "Static", $var9, "false" );unset( $var9 );
if (! isset( $var8 ) ) $var8 = NULL;
while ( is_object( $var8 ) and method_exists( $var8, 'templateValue' ) )
    $var8 = $var8->templateValue();
$var = array( $var1, $var2, $var3, $var4, $var5, $var6, $var7, $var8 );unset( $var1, $var2, $var3, $var4, $var5, $var6, $var7, $var8 );
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
$vars[$currentNamespace]['caches_list'] = $var;
unset( $var );
$text .= '
<form id="clearcache" action="/hollywood/index.php/site_admin/setup/cachetoolbar" method="post">';
...
$text .= ' name="CacheTypeValue">
   ';
unset( $loopItem );
unset( $loopItem );
$loopItem = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'caches_list', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['caches_list'] : null;
...
unset( $var2 );
unset( $var2 );
$var2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'selected_cache_type', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['selected_cache_type'] : null;
if (! isset( $var2 ) ) $var2 = NULL;
while ( is_object( $var2 ) and method_exists( $var2, 'templateValue' ) )
    $var2 = $var2->templateValue();
while ( is_object( $var2 ) and method_exists( $var2, 'templateValue' ) )
...
$text .= ' type="submit" name="ClearCacheButton" value="Leeren" />
</div>';
...
$setArray = $oldSetArray_7b86cea6765b0c7c135c90266796cf76;
$tpl->Level--;
?>
