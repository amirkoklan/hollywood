...
$oldSetArray_47aa7c6657b93dc8b263ef76a1b9f074 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    <li id="shoppingbasket"><a href="/hollywood/index.php/shop/basket" title="Shopping basket">Shopping basket</a></li>
   ';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    <li id="myprofile"><a href="/hollywood/index.php/user/edit" title="My profile">My profile</a></li>
    <li id="logout"><a href="/hollywood/index.php/user/logout" title="Logout">Logout ( ';
unset( $var );
unset( $var1 );
unset( $var1 );
...
if ( $if_cond )
{
$text .= '    <li id="registeruser"><a href="/hollywood/index.php/user/register" title="Register">Register</a></li>
    ';
}
unset( $if_cond );
// if ends
...
$text .= '    <li id="login" class="transition-showed">
        ...
        <form class="login-form span3" action="/hollywood/index.php/user/login" method="post">
            <fieldset>
                <label>
                ...
                <div class="clearfix">
                    <a href="/hollywood/index.php/user/forgotpassword" class="forgot-password">Forgot your password?</a>
...
$setArray = $oldSetArray_47aa7c6657b93dc8b263ef76a1b9f074;
$tpl->Level--;
?>
