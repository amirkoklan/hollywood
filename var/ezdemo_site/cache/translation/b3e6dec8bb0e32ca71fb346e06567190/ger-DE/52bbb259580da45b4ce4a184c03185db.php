...
$TranslationRoot = array (
  ...
  'a1a244ed9ba33b422adcbcd050158ac7' => 
  array (
    'context' => 'design/admin/setup/rad',
    ...
    'comment' => NULL,
    'translation' => 'Das Werkzeuge zur schnellen Anwendungs-Entwicklung (rapid application development, RAD) vereinfacht die Entwicklung von neuen oder erweiterten Funktionen von eZ publish. Im Moment gibt es zwei RAD Werkzeuge: Der Assistent für Template Operatoren und der Assistent für Datentypen. Der Assistent für Template Operatoren erstellt hauptsächlich eine gültige Umgebung (PHP Code) für neue Template Operatoren. Der Assistent für Datentypen erstellt eine gültige Umgebung (PHP Code) für einen neuen Datentypen.',
    'key' => 'a1a244ed9ba33b422adcbcd050158ac7',
  ),
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Verfügbare RAD Werkzeuge',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Assistent für Template Operatoren',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Assistent für Template Operatoren (Schritt 1 von 3)',
    'key' => '21c8a9061a282fe20e2506e22fa51498',
  ),
  '1aaec839268623c2467285f8fff33b28' => 
  array (
    'context' => 'design/admin/setup/rad',
    'source' => 'Welcome to the template operator wizard. Template operators are usually used for manipulating template variables. However, they can also be used to generate or fetch data. This wizard will take you through a couple of steps with some basic choices. When finished, eZ publish will generate a PHP framework for the a new operator (which will be available for download).',
    'comment' => NULL,
    'translation' => 'Willkommen zum Assistent für Template Operatoren. Template Operatoren werden normalerweise benutzt um Templatevariablen zu manipulieren. Sie können aber auch dazu genutzt werden um Daten zu erzeugen oder auszulesen. Dieser Assistent wird Sie durch einige Schritte mit grundsätzlichen Auswahlmöglichkeiten führen. Wenn er beendet ist, wird eZ publish eine Umgebung in PHP für einen neuen Operatoren erzeugen (der dann zum Download bereitsteht).',
    'key' => '1aaec839268623c2467285f8fff33b28',
  ),
  ...
  '519eef6a76f87c9494ffb5906756aad4' => 
  array (
    'context' => 'design/admin/setup/rad',
    'source' => 'Welcome to the template operator wizard. Template operators are usually used for manipulating template variables. However, they can also be used to generate or fetch data. This wizard will take you through a couple of steps with some basic choices. When finished, eZ Publish will generate a PHP framework for the a new operator (which will be available for download).',
    'comment' => NULL,
    'translation' => 'Willkommen zum Assistent für Template Operatoren. Template Operatoren werden normalerweise benutzt um Templatevariablen zu manipulieren. Sie können aber auch dazu genutzt werden um Daten zu erzeugen oder auszulesen. Dieser Assistent wird Sie durch einige Schritte mit grundsätzlichen Auswahlmöglichkeiten führen. Wenn er beendet ist, wird eZ publish eine Umgebung in PHP für einen neuen Operatoren erzeugen (der dann zum Download bereitsteht).',
    'key' => '519eef6a76f87c9494ffb5906756aad4',
  ),
